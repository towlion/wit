...
export default function NotificationBell() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-[-0.5rem] sm:right-0 top-full mt-2 w-[calc(100vw-2rem)] sm:w-80 max-w-sm bg-[var(--bg-primary)] border border-[var(--border)] rounded-xl shadow-2xl shadow-black/40 z-50 animate-fade-in overflow-hidden">
